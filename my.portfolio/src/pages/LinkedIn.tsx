...
export const LinkedIn = () => {
   const classes = useStyles();
    return (
        <div>
            <Typography variant="h3" className={classes.title}>Introduction
            <Button className={`${classes.paper} ${classes.buttonPadding}`} onClick={() => window.open("https://www.linkedin.com/in/travis-anderson-60106a107/", "_blank")}> View Travis's Linkedin Profile
            </Button></Typography>
