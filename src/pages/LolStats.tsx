  ...
  return (
    ...
    >
      ...
      >
          ...
          <Box sx={{ flex: [1, 2], height: "100%", width: "90%" }}>
            ...
            >
              <ImageListItem sx={{ ...picEffect, position: "relative" }}>
                <img style={{ width: "100%" }} src={sitePic1} alt="sitePic1" />
                <div>
                  <ImageListItemBar
                    sx={{ width: "100%" }}
                    title={"Champion stats tracker"}
                    subtitle={"http://lolstatsportfolio.heroku.com0"}
                  />
                </div>
                <Typography
                  component={"span"}
                  ...
                  onClick={() =>
                    window.open("https://travisanderson.xyz/lolstats", "_blank")
                  }
                >
                  <Typography
                    component={"p"}
        ...
        >
          This was a passion project that I built in ReactJS to manipulate and
          view data about various characters in the online game:League of
          Legends. I was the Sole author on this project responsible for both
          the front-end and back-end.
        </Typography>
        <a href={"https://github.com/Spotexx/lolstats"}>
          <Typography
            component={"div"}
            sx={{
