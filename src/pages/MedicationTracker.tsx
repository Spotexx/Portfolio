  ...
  return (
    ...
    >
      ...
      >
          ...
          <Box sx={{ flex: [1, 2], height: "100%", width: "90%" }}>
            ...
            >
              <ImageListItem sx={{ ...picEffect }}>
                <img style={{ width: "100%" }} src={MedPic1} alt="sitePic1" />
                <div>
                  <ImageListItemBar
                ...
                <Typography
                  ...
                  onClick={() =>
                    window.open(
                      "https://travisanderson.xyz/medication-tracker",
                      "_blank"
                    )
                  }
                >
        ...
        >
          This is a medication Tracker I built to track various medications on a
          calendar and dashboard view. For this assignment I was a Co-developer
